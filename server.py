...
def init_db():
    ...
    conn.executescript("""
        ...
        -- ============================================================
        -- 2026-06-05 plugin-séma (FÁZIS 2A) — a fő szál hozza létre,
        -- a plugins/*.py pluginok CSAK használják (nem CREATE-elnek).
        -- ============================================================

        -- signal_gatekeeper: jel→kimenet ítéletek naplója (A agent)
        ...
        -- semantic_triage_log: embedding-alapú email-besorolások (B agent)
        ...
        -- draft_log: generált Gmail draftok naplója (C agent — SOHA nem küld)
        ...
        -- digest_state: napi email-digest állapot + watermark (D agent)
        ...
        -- action_drafts: emailből kinyert naptár/teendő DRAFTOK (E agent —
        -- jóváhagyásig status='pending', SOHA nem auto-create)
...
SYNTHESIS_PRODUCT_CORE = (
    ...
    "FORMA:\n"
    "- A FELADAT által kért formátum az úr, és a lenti default regisztert IS "
    "felülírja: ha bullet-összefoglalót kér, bullet-listát adj; ha elemzést, "
    "folyékony prózát; ha táblát, táblát.\n"
    "- Ha a feladat nem ír elő formát: magyar think-tank/policy-elemző "
    "regiszter (mérce: MNB Inflációs Jelentés, CEPA policy brief), "
    "irányadóan ~700 szó (a TELJESSÉG szabálya ezt felülírhatja), "
    "strukturált címhierarchiával, tömör és számokkal alátámasztott.\n"
    "- Az első bekezdés 3-4 mondatos, önállóan is megálló kulcs-üzenet.\n\n"
    "TELJESSÉG — A LEGELSŐ SZABÁLY:\n"
    "- A tartalom az agentek EGYEDI hozzájárulásainak TELJES UNIÓJA: MINDEN "
    "jól forrásolt tény bekerül, pontosan egyszer, a tematikus helyén — "
    "semmi nem vész el és semmi nem duplikálódik.\n"
    "- A hossz-cél CSAK akkor érvényes, ha minden tény belefér. Ütközés "
    "esetén MINDIG a teljesség nyer: a szöveg nőhet, tényt terjedelmi okból "
    "kihagyni TILOS. Inkább tömöríts mondatszinten (egy tény = egy tömör "
    "tagmondat), mint hogy tényt dobj el.\n"
    "- LEZÁRÁS ELŐTTI ÖNELLENŐRZÉS (kötelező): menj végig még egyszer az "
    "összes al-agent anyagán tételesen, és ellenőrizd, hogy minden forrásolt "
    "tényük szerepel-e a szövegedben. Ami kimaradt, azt illeszd be a "
    "megfelelő szekcióba, mielőtt befejezed.\n\n"
